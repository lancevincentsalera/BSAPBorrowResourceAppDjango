...
class Resident(User):
    ...
    documents = models.ManyToManyField("RequestDocument.Document", through="RequestDocument.DocumentRequest")
...
class Admin(User):
    ...
    approve_doc_request = models.OneToOneField("RequestDocument.DocumentRequest", on_delete=models.CASCADE)
